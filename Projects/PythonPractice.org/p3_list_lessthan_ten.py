...
# in it and print out this new list. (done)
# 2. Write this in one line of Python. (not done)
# 3. Ask the user for a number and return a list that contains only elements from the original list
# that are smaller than that number given by the user. (just replace 5 with input from user)
